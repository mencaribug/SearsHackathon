...
// API Specification:
// Prefix is always "/:cartId/"
// POST /:cartId/comment/ with body
// GET /:cartId/ returns a page (not very ajaxy)
...
function makeNewItem(url) {
    var item = { id: nextId(), ratings: [{name: "Love it", count: 0}, {name: "Hate it", count: 0}, {name: "Maybe?", count: 0}], comments: [], url: url, img: "/images/placeholder.png", name: "Uninitialized item", chatLog: [] };
    return item;
}
...
function scrapeProductName(item, callback) {
    ...
    GET("http://api.developer.sears.com/v2.1/products/details/sears/json/" + productId + "?apikey=pLZJ1YdF0gJQYa4w5QmqRrPb7DWWi9Rx", function (json) {
